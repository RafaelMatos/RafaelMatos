...
<div style="display: inline_block"><br>
 ...
 <br>
  ...
  <h4><a href="https://github.com/RafaelMatos/DtMoney" target="_blank">DtMoney</a></h4>
  <p>Projeto realizado no curso da Rocketseat na trilha React do Ignite. Nesse projeto será construida uma aplicação front-end web completa, conectando a uma API e será visto como performar aplicações com o React entendendo como funcionam os algoritmos internos da biblioteca e todo fluxo de renderização de componentes.</p>
